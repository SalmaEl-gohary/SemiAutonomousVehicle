...
#elif MSPI2_SS_MANAGEb == SW_SLAVE_MANAGEMENT
...
u8 MSPI1_voidSendDataU8 ( u8 Copy_u8Data ){
	...
	//MGPIO_vidSetPinValue(_GPIOA_PORT, _PIN_0, _LOW) ;
	...
	//MGPIO_vidSetPinValue(_GPIOA_PORT, _PIN_0, HIGH) ;

	/* Return to the received data */
	return (u8) MSPI1 -> DR ;

}
u8 MSPI2_voidSendDataU8 ( u8 Copy_u8Data ){
