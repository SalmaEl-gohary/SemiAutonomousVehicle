...
void MEXTI_voidSetSignalLatch( u8 Copy_u8Line,  u8 Copy_u8EXTISenseMode )
{
	...
	{
	case (Rising_Edage):	 SET_BIT( EXTI_Ptr -> RTSR, Copy_u8Line );	break;



	case (Falling_Edage):	SET_BIT( EXTI_Ptr -> FTSR, Copy_u8Line );	   break;


	case (On_Change) :
					SET_BIT( EXTI_Ptr -> FTSR, Copy_u8Line );
	SET_BIT( EXTI_Ptr -> RTSR, Copy_u8Line );	  break;
...
void MEXTI2_voidSetCallBack( void (*ptr) (void))
{
	...
	EXTI2_CallBack =ptr  ;	// Now The Global EXTI1_Call Will Point TO Any Functiom You Will Pass It To Function Only Give Function It's Name
...
void MEXTI3_voidSetCallBack( void (*ptr) (void))
{
	...
	EXTI3_CallBack =ptr  ;	// Now The Global EXTI1_Call Will Point TO Any Functiom You Will Pass It To Function Only Give Function It's Name
...
void EXTI1_IRQHandler(void){
	...
	EXTI1_CallBack();
	SET_BIT( EXTI_Ptr->PR , 1 );					// With Out That It Will Do INT Alaways
}

void EXTI2_IRQHandler(void){

	EXTI2_CallBack();
	SET_BIT( EXTI_Ptr->PR , 2 );					// With Out That It Will Do INT Alaways
}

void EXTI3_IRQHandler(void){

	EXTI3_CallBack();
	SET_BIT( EXTI_Ptr->PR , 3 );					// With Out That It Will Do INT Alaways
}
